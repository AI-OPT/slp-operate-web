        ...
        <div class="form-wrapper"><!--白底内侧-->
            <div class="nav-tplist-wrapper"><!--白底内侧-->
                ...
                <div class="title-right">
                    <p class="plus"><a href="javascript:void(0);"><i class="icon-plus"></i></a></p>
                                    ...
                                    <div class="setup-sku mg-0">
                                        <ul>
                                            <li>
                                                ...
                                                <p><input type="button" class="biu-btn btn-blue stock-btn"
                                                                            value="编辑名称 ">
                                                </p>
                                                <p>总库存量:${storGroup.storageTotal }</p>
                                                <p><input id="${storGroup.storageGroupId }priority"
                                                          name="addPriorityNumber" type="button"
                                                          class="biu-btn btn-blue stock-btn" value="增加优先级 ">
                                                </p>
                                                <p><input type="button" class="biu-btn btn-blue stock-btn" value="启动 ">
                                                </p>
                                                <p><input type="button" class="biu-btn btn-blue stock-btn"
                                                                            value="废弃 ">
                                                </p>
                                        ...
                                        <div id="selectDiv" class="setup-sku mg-0">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p><a href="javascript:void(0);"><img
                                                            src="${_slpres }/images/up.png"/></a></p>
                                                    <p><input id="addStorageShow" type="button"
                                                              class="biu-btn btn-blue stock-btn" id="small-eject3"
                                                              value="增加库存" storGroupId="${storGroup.storageGroupId }"
                                                              priorityNum="${priority.key}" number="${priority.value.size()}">
                                                    </p>
                                                    <p>
                                                    ...
                                                    <p class="eject-int">
                                                        <input id="${storGroup.storageGroupId }${priority.key}activeTime"
                                                            type="input" class="int-text int-mini">
                                                        <a href="javascript:void(0);"><i class="icon-calendar"></i></a>
                                                    </p>
                                                    <p class="eject-int">~</p>
                                                    <p class="eject-int">
                                                        <input id="${storGroup.storageGroupId }${priority.key}inactiveTime"
                                                            type="input" class="int-text int-mini">
                                                        <a href="javascript:void(0);"><i class="icon-calendar"></i></a>
                                                    </p>
                ...
                <script id="storageTemple" type="text/template">
                    <tr id="{{:storageGroupId }}{{:priorityNumber }}{{:number }}">
                        ...
                        <td><a href="javascript:void(0);" class="blue">编辑</a>
                            ...
                            <a href="javascript:void(0);" class="blue">管理预警接收人</a></td>
                        {{/if}}
                    </tr>
                </script>
                            ...
                            <div class="setup-sku mg-0">
                                <ul>
                                    <li>
                                        ...
                                        <p><input id="${attr.storageGroupId }addPriorityNumber" name="addPriorityNumber"
                                                  type="button" class="biu-btn btn-blue stock-btn" value="增加优先级 "></p>
