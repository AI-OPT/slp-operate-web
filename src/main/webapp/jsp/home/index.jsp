                    ...
                    <div class="nav-tplist-table commodity-tplist-table">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>话费</td>
                                <td>虚拟</td>
                                <td><img src="../images/sp-01.png"></td>
                                <td>中国移动100元充值卡</td>
                                <td>6000</td>
                                <td>未编辑</td>
                            ...
                            <tr>
                                ...
                                <td>流量</td>
                                <td>虚拟</td>
                                <td><img src="../images/sp-02.png"></td>
                                <td>中国移动100元充值卡</td>
                                <td>6000</td>
                                <td>已保存</td>
                                <td>2016-3-18 13:25</td>
                    ...
                    <div class="nav-tplist-table commodity-tplist-table">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>6000</td>
                                <td>
                                    <div class="commod-table">
                                        <p>类型：信息有误</p>
                                        <p>描述：商品运营商类型填写错误...... <a href="#" class="details">显示全部</a></p>
                                    </div>
                                </td>
                                <td>2016-3-18 13:25</td>
                                <td>
                    ...
                    <div class="nav-tplist-table commodity-tplist-table">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div><p>审核中</p>
                                        <p class="color"><img src="../images/icon-c.png"/>已申请优先</p></div>
                                </td>
                                <td>2016-3-18 13:25</td>
                                <td>
                                    <div>
...
<script src="${_slpbase }/scripts/metismenu.js"></script>
